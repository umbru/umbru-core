...
This document provides guidelines for internationalization of the Umbru Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `umbru_en.ts` remains unchanged.
