...
This mechanism has been integrated into Bitcore-Node-Umbru which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/umbru/insight-api-umbru#web-socket-api](https://github.com/umbru/insight-api-umbru#web-socket-api)
* API: [https://github.com/umbru/insight-api-umbru#instantsend-transactions](https://github.com/umbru/insight-api-umbru#instantsend-transactions)
