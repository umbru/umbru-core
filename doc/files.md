...
* umbru.conf: contains configuration settings for umbrud or umbru-qt
* umbrud.pid: stores the process id of umbrud while running
* database/*: BDB database environment; only used for wallet
* db.log: wallet database log file
* debug.log: contains debug information and general logging generated by umbrud or umbru-qt
