...
void masternode_list_help()
{
    throw std::runtime_error(
            ...
            "  owneraddress   - Print the masternode owner Umbru address\n"
            "  payee          - Print the masternode payout Umbru address (can be additionally filtered,\n"
            "                   partial match)\n"
            "  pubKeyOperator - Print the masternode operator public key\n"
            "  status         - Print masternode status: ENABLED / POSE_BANNED\n"
            "                   (can be additionally filtered, partial match)\n"
            "  votingaddress  - Print the masternode voting Umbru address\n"
        );
}
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    { "umbru",               "masternode",             &masternode,             true,  {} },
    { "umbru",               "masternodelist",         &masternodelist,         true,  {} },
    { "umbru",               "getpoolinfo",            &getpoolinfo,            true,  {} },
#ifdef ENABLE_WALLET
    { "umbru",               "privatesend",            &privatesend,            false, {} },
#endif // ENABLE_WALLET
};
