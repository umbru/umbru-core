...
#define BOOST_TEST_MODULE Umbru Test Suite

#include "test_umbru.h"
...
TestingSetup::TestingSetup(const std::string& chainName) : BasicTestingSetup(chainName)
{
    const CChainParams& chainparams = Params();
        ...
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_umbru_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
