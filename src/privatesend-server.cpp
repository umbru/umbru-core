...
void CPrivateSendServer::ProcessMessage(CNode* pfrom, const std::string& strCommand, CDataStream& vRecv, CConnman& connman)
{
    ...
    if (fLiteMode) return; // ignore all Umbru related functionality
...
/*
    ...
    allow endless transaction that would bloat Umbru and make it unusable. To
...
{
    if (fLiteMode) return;        // disable all Umbru specific functionality
